# Start API + Streamlit; Ctrl+C or closing this window stops both and releases ports.
...
) -WorkingDirectory $Src -PassThru -WindowStyle Normal

Start-Sleep -Seconds 2

Write-Host "Starting Streamlit on port $FePort ..."
