"""Short-term conversation memory: trim, load, and build LLM message lists."""

from __future__ import annotations

from typing import Any

from api.chat_session_store import get_session, list_messages
...
def truncate_assistant_for_history(content: str, *, max_chars: int = 600) -> str:
    """Shrink long KB answers in history to reduce topic bleed."""
